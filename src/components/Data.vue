                ...
                <div class="modal-body">
                   <form>
                    <div class="form-group">
                      ...
                      <input v-model="item.amount" type="number" class="form-control" id="recipient-name" />
                    </div>
                     <div class="form-group">
                      <label for="recipient-name" class="col-form-label">Buổi:</label>
                      <input v-model="item.session" type="text" class="form-control" id="recipient-name" />
                    </div>
                     <div class="form-group">
                      <label for="recipient-name" class="col-form-label">Nơi tổ chức:</label>
                      <input v-model="item.place" type="text" class="form-control" id="recipient-name" />
                    </div>
                     <div class="form-group">
                      <label for="recipient-name" class="col-form-label">Tên khách:</label>
                      <input v-model="item.name" type="text" class="form-control" id="recipient-name" />
                    </div>
                     <div class="form-group">
                      <label for="recipient-name" class="col-form-label">Giới tính:</label>
                      <input v-model="item.sex" type="text" class="form-control" id="recipient-name" />
                    </div>
                     <div class="form-group">
                      <label for="recipient-name" class="col-form-label">Ngày:</label>
                      <input v-model="item.date" type="date" class="form-control" id="recipient-name" />
                    </div>
                     <div class="form-group">
                      <label for="recipient-name" class="col-form-label">Món:</label>
                      <input v-model="item.choose" type="text" class="form-control" id="recipient-name" />
                    </div>
                     <div class="form-group">
                      <label for="recipient-name" class="col-form-label">Yêu cầu:</label>
                      <input v-model="item.request" type="text" class="form-control" id="recipient-name" />
                    </div>
                     <div class="form-group">
                      <label for="recipient-name" class="col-form-label">Qua:</label>
                      <input v-model="item.sourcesss" type="text" class="form-control" id="recipient-name" />
                    </div>
                  </form>
                </div>
